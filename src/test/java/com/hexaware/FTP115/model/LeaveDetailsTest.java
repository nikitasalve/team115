...
public class LeaveDetailsTest {
  ...
  * @throws ParseException for converting date to string.
  ...
  public final void testApplyLeave(@Mocked final EmployeeDAO edao, @Mocked final LeaveDetailsDAO ldao)
    ...
    new Expectations() {
      {
        ldao.insert(2, "2019-04-20", "2019-04-21", LeaveType.EL, "sick", strToday, LeaveStatus.APPROVED, 100);
    ...
    String res9 = LeaveDetails.applyLeave(200, "2019-04-21", "2019-04-14", 1, LeaveType.EL, "sick");
