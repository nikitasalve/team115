...
public class LeaveDetailsRestTest {
 ...
 @Test
	public void testLeaveDetailsList() throws AssertionError, URISyntaxException, ParseException{
		...
		LeaveDetails res = given().accept(ContentType.JSON).when()
				.get(CommonUtil.getURI("/api/leavedetails/1")).getBody().as(LeaveDetails.class);
				 LeaveDetails l1 = new LeaveDetails(1, 1, s, e, LeaveType.EL, "sick", l, LeaveStatus.APPROVED, "jh", 2000);
    ...
    final String s4 = "2019-10-10";
    final Date s11 = sdf1.parse(s4);
    final String s5 = "2019-10-10";
    final Date e11 = sdf1.parse(s5);
    final String s6 = "2019-02-01";
...
LeaveDetails res1 = given().accept(ContentType.JSON).when()
              ...
              LeaveDetails l2 = new LeaveDetails(3, 1, s11, e11, LeaveType.EL, "sick", l11, LeaveStatus.APPROVED, "hgsdf", 2000);
    ...
    final Date l = sdf.parse(s3);
           ...
           LeaveDetails l2 = new LeaveDetails(4, 1, s, e, LeaveType.EL, "sick", l, LeaveStatus.REJECTED, "meeting", 3000);
    ...
    final Date l = sdf.parse(s3);
           LeaveDetails[] res = given().accept(ContentType.JSON).when()
				.get(CommonUtil.getURI("/api/leavedetails/leavepending/1000")).getBody().as(LeaveDetails[].class);
           LeaveDetails l2 = new LeaveDetails(56, 1, s, e, LeaveType.EL, "sick", l, LeaveStatus.PENDING, null, 4000);
           assertEquals(res[0].getLeaId(), l2.getLeaId());
    }
...
@Test
    public void testApproveDeny() throws AssertionError, URISyntaxException {
        ...
        assertEquals("Leave already approved", res2);
