 ...
 */
  ...
  public static LeaveDetails[] listPending(final int empId) {
   ...
   /**
   * get the list of all leave details.
   * @return all leave details
   */
  public static LeaveDetails[] listAll1() {
